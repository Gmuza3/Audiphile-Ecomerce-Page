        ...
        <div className={style['sign-zone']}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div style={{paddingTop:"10px"}}>
                    <Button buttonType="submit" text={"submit"} buttonName={"btn-primary-100"} />
                </div>
                <div>
                    <span style={{display:'flex', gap:"12px"}}>
                        Don't have an Account? 
                        <Button isLink={true} path="/signup" buttonName="active-bold-gray" text={"Sign Up"}/>
                    </span>
                </div>
            </form>
        </div>
