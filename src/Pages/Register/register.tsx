...
const Register = () => {
  ...
  return (
    <div style={{minHeight:'100vh'}} className={style['register-zone']}>
        {show && (
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={style['regButton-zone']}>
                <Button buttonType="submit" text={"Login"} buttonName={"btn-primary-100"} />
            </div>
        </form>
    </div>
  )
